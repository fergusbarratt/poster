...
\begin{minipage}{\linewidth}
    % a0 linewidth = 84.1cm
\hspace{2cm}
    \includegraphics[width=20cm]{epsrc_high}
\hspace{50cm}
    \includegraphics[width=10cm]{kings-logo}
\end{minipage}
}
\makeatother
...
\begin{itemize}
    ...
    \item E.g.\ Adiabatic quantum computation 
    \item Tools from Statistical Mechanics?
\end{itemize}
\vspace{0.5cm}
\end{Section}
...
\begin{Section2}{II: Aims}
    \begin{itemize}
        ...
        \item Keldysh theory $\rightarrow$ dissipation: \\
            analogous to bias in trajectory ensembles?
        \item Transition from usable quantum resources \\
            (i.e.\ entanglement) to absence.
    \end{itemize}
            \vspace{-11cm}\flushright\includegraphics[width=0.5\linewidth]{dyn_phase_transition}\flushleft
            \vspace{-1cm}
...
\captionof{figure}{Time-dependent variational principle}
\end{Section}
...
\begin{Section}{3: Non-Equilibrium QFT: Keldysh}
        ...
        \captionof{figure}{Different dynamical behaviour}
...
\includegraphics[width=\linewidth, height=8cm]{keldysh}
